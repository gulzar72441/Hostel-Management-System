...
{
    public class GetHostelPaymentsEndpoint : Endpoint<GetHostelPaymentsRequest, PagedResponse<PaymentResponse>>
    {
        private readonly ApplicationDbContext _context;

        public GetHostelPaymentsEndpoint(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public override async Task HandleAsync(GetHostelPaymentsRequest req, CancellationToken ct)
        {
