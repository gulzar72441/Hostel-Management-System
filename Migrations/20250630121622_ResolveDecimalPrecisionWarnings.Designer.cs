...
namespace HostelManagementSystemApi.Migrations
{
    ...
    [Migration("20250630121622_ResolveDecimalPrecisionWarnings")]
    partial class ResolveDecimalPrecisionWarnings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmenityHostel", b =>
                {
                    b.Property<int>("AmenitiesAmenityID")
                        .HasColumnType("int");

                    b.Property<int>("HostelsHostelID")
                        .HasColumnType("int");

                    b.HasKey("AmenitiesAmenityID", "HostelsHostelID");

                    b.HasIndex("HostelsHostelID");

                    b.ToTable("AmenityHostel");
                });

            modelBuilder.Entity("HostelManagementSystemApi.Domain.Amenity", b =>
                {
            ...
            modelBuilder.Entity("AmenityHostel", b =>
                {
                    b.HasOne("HostelManagementSystemApi.Domain.Amenity", null)
                        .WithMany()
                        .HasForeignKey("AmenitiesAmenityID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HostelManagementSystemApi.Domain.Hostel", null)
                        .WithMany()
                        .HasForeignKey("HostelsHostelID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HostelManagementSystemApi.Domain.Bed", b =>
                {
                    ...
                    b.HasOne("HostelManagementSystemApi.Domain.Student", "Student")
                        .WithOne("Bed")
                        .HasForeignKey("HostelManagementSystemApi.Domain.Bed", "StudentID")
            ...
            modelBuilder.Entity("HostelManagementSystemApi.Domain.Room", b =>
                {
                    ...
                    b.HasOne("HostelManagementSystemApi.Domain.RoomType", "RoomType")
                        .WithMany()
